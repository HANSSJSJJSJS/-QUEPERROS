...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <style>
            @font-face {
                font-family: 'Furreal';
                src: url("{{ asset('fonts/furreal.otf') }}") format('opentype');
                font-weight: 400;
                font-style: normal;
                font-display: swap;
            }
            ...
            @font-face {
                ...
                src: url("{{ asset('fonts/furrealcolor.otf') }}") format('opentype');
                font-weight: 400;
                font-style: normal;
                font-display: swap;
            }
                    ...
                    <div class="mq-about-grid">
                        <div class="mq-about-card">
                            <div class="mq-about-tagline">
                                <svg class="mq-rainbow" viewBox="0 0 90 70" fill="none" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
                                    <path d="M14 56C14 35 31 18 52 18" stroke="#E67E22" stroke-width="8" stroke-linecap="round"/>
                                    <path d="M24 56C24 41 37 28 52 28" stroke="#B0B03A" stroke-width="8" stroke-linecap="round"/>
                                    <path d="M34 56C34 46 42 38 52 38" stroke="#5A6CCB" stroke-width="8" stroke-linecap="round"/>
                                </svg>
                    ...
                    <div class="mq-services-grid">
                        <article class="mq-card-ui" aria-label="Entrenamiento canino">
                            ...
                            <ul class="mq-paw-list">
                                <li class="mq-paw-item"><span class="mq-paw" aria-hidden="true"><svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><path d="M20 30c-4 0-7-4-7-9s3-9 7-9 7 4 7 9-3 9-7 9Zm24 0c-4 0-7-4-7-9s3-9 7-9 7 4 7 9-3 9-7 9ZM12 44c-4 0-7-4-7-8s3-8 7-8 7 4 7 8-3 8-7 8Zm40 0c-4 0-7-4-7-8s3-8 7-8 7 4 7 8-3 8-7 8ZM32 60c-10 0-18-6-18-14 0-9 9-18 18-18s18 9 18 18c0 8-8 14-18 14Z"/></svg></span><span>Entrenamiento básico integral y deportivo</span></li>
                                <li class="mq-paw-item"><span class="mq-paw" aria-hidden="true"><svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><path d="M20 30c-4 0-7-4-7-9s3-9 7-9 7 4 7 9-3 9-7 9Zm24 0c-4 0-7-4-7-9s3-9 7-9 7 4 7 9-3 9-7 9ZM12 44c-4 0-7-4-7-8s3-8 7-8 7 4 7 8-3 8-7 8Zm40 0c-4 0-7-4-7-8s3-8 7-8 7 4 7 8-3 8-7 8ZM32 60c-10 0-18-6-18-14 0-9 9-18 18-18s18 9 18 18c0 8-8 14-18 14Z"/></svg></span><span>Formación y crianza para perros de trabajo o especialidades</span></li>
                            </ul>
                        </article>
                        ...
                        <article class="mq-card-ui" aria-label="Cuidado y alojamiento">
                            ...
                            <ul class="mq-paw-list">
                                <li class="mq-paw-item"><span class="mq-paw" aria-hidden="true"><svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><path d="M20 30c-4 0-7-4-7-9s3-9 7-9 7 4 7 9-3 9-7 9Zm24 0c-4 0-7-4-7-9s3-9 7-9 7 4 7 9-3 9-7 9ZM12 44c-4 0-7-4-7-8s3-8 7-8 7 4 7 8-3 8-7 8Zm40 0c-4 0-7-4-7-8s3-8 7-8 7 4 7 8-3 8-7 8ZM32 60c-10 0-18-6-18-14 0-9 9-18 18-18s18 9 18 18c0 8-8 14-18 14Z"/></svg></span><span>Hotel canino</span></li>
                                <li class="mq-paw-item"><span class="mq-paw" aria-hidden="true"><svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><path d="M20 30c-4 0-7-4-7-9s3-9 7-9 7 4 7 9-3 9-7 9Zm24 0c-4 0-7-4-7-9s3-9 7-9 7 4 7 9-3 9-7 9ZM12 44c-4 0-7-4-7-8s3-8 7-8 7 4 7 8-3 8-7 8Zm40 0c-4 0-7-4-7-8s3-8 7-8 7 4 7 8-3 8-7 8ZM32 60c-10 0-18-6-18-14 0-9 9-18 18-18s18 9 18 18c0 8-8 14-18 14Z"/></svg></span><span>Guardería (solo para la calera y zonas aledañas)</span></li>
                            </ul>
                        </article>
                        ...
                        <article class="mq-card-ui mq-services-center" aria-label="Otras actividades">
                            ...
                            <ul class="mq-paw-list">
                                <li class="mq-paw-item"><span class="mq-paw" aria-hidden="true"><svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><path d="M20 30c-4 0-7-4-7-9s3-9 7-9 7 4 7 9-3 9-7 9Zm24 0c-4 0-7-4-7-9s3-9 7-9 7 4 7 9-3 9-7 9ZM12 44c-4 0-7-4-7-8s3-8 7-8 7 4 7 8-3 8-7 8Zm40 0c-4 0-7-4-7-8s3-8 7-8 7 4 7 8-3 8-7 8ZM32 60c-10 0-18-6-18-14 0-9 9-18 18-18s18 9 18 18c0 8-8 14-18 14Z"/></svg></span><span>Día de diversión en Más que Perros</span></li>
                                <li class="mq-paw-item"><span class="mq-paw" aria-hidden="true"><svg viewBox="0 0 64 64" xmlns="http://www.w3.org/2000/svg"><path d="M20 30c-4 0-7-4-7-9s3-9 7-9 7 4 7 9-3 9-7 9Zm24 0c-4 0-7-4-7-9s3-9 7-9 7 4 7 9-3 9-7 9ZM12 44c-4 0-7-4-7-8s3-8 7-8 7 4 7 8-3 8-7 8Zm40 0c-4 0-7-4-7-8s3-8 7-8 7 4 7 8-3 8-7 8ZM32 60c-10 0-18-6-18-14 0-9 9-18 18-18s18 9 18 18c0 8-8 14-18 14Z"/></svg></span><span>Plan padrino</span></li>
                            </ul>
                        </article>
                    </div>
                </div>
